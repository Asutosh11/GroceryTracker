package com.highloop.homemaker.data.dao

import android.content.Context
import android.util.Log
import com.google.gson.Gson
import com.highloop.homemaker.data.pojo.AllProducts
    ...
    companion object{
        ...
        fun saveOneProduct(list : Product){
            ...
            if(!getAllOfflineItemsNames().contains(list.listName)){
                var item : ItemsListDAO = ItemsListDAO()
        ...
        fun getAllOfflineData() : ArrayList<Product> {
            ...
            for(product in result){
                productsList.add(Product(product.itemName, product.itemQuantity, product.itemUnit, product.itemCategory))
            }
